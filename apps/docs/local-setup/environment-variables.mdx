...
| `NEXT_PUBLIC_GITHUB_URL` | Recommended | Public GitHub repository URL for marketing and docs links. Default: `https://github.com/payoesteam/payoes` |
...
NEXT_PUBLIC_GITHUB_URL=https://github.com/payoesteam/payoes
```
