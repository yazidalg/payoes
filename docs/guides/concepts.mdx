...
All payment products inherit asset configuration from organization assets. Invoices and subscriptions do not store their own asset — a payment is created automatically with the organization's default settlement asset and enabled allowed assets.
