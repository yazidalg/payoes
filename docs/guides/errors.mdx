...
**Fix:** Add a trustline to the correct USDC issuer for your network. See [Receiving wallet](/guides/receiving-wallet).
...
| Payment was sent to a different address | Destination does not match receiving wallet |
...
- Confirm receiving wallet and trustlines are configured for the payment asset
