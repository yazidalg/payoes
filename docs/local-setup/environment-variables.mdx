...
| Variable | Required | Description |
|----------|----------|-------------|
| `STELLAR_TESTNET_OPERATOR_SECRET` | For escrow / Soroban sandbox | Funded testnet account for auth, deposits, and sandbox simulation |
| `SOROBAN_TESTNET_RPC_URL` | For Soroban sandbox | Soroban RPC URL. Default: `https://soroban-testnet.stellar.org` |
| `SOROBAN_TESTNET_CONTRACT_ID` | For Soroban sandbox | Deployed Payoes contract ID |
