...
See [Environments](/guides/environments) for dashboard mode switching and receiving wallets.
...
| `POST` | `/subscriptions/{id}/bill` | Bill the current period (creates and finalizes an invoice) |
...
| Version | Changes |
|---------|---------|
| `v1` | Payments, customers, checkout sessions, payment links, invoices, and subscriptions APIs |
